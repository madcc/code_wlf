...
#define ThermcoupleSck_Port GPIOC
#define ThermcoupleCs_Port GPIOC
#define ThermcoupleDo_Port GPIOC
...
#define Z_Axis_Max_Port GPIOC
#define Z_Axis_Max_Pin GPIO_Pin_15
